...
paste dates.tmp $regfile | awk 'NF>=5{printf("%8.3f %8.3f %5.0f %5.0f %s 1 0\n",$3,$4,$3,$4,$2)}' > phot.data.tmp
...
paste $astname.photast.tmp $regfile > ${astname}_2.photast
#python ~/cfht-pip2/timefity_2.py $astname
